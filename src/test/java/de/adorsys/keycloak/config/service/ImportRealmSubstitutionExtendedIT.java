...
@TestPropertySource(properties = {
        ...
        "test.property.value=value from property"
})
...
class ImportRealmSubstitutionExtendedIT extends AbstractImportTest {
    ...
    void shouldCreateRealm() throws IOException {
        ...
        assertThat(env.getProperty("test.property.value"), is("value from property"));
        assertThat(env.getProperty("test.configtree.value"), is("value from configtree"));
